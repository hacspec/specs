...
pub fn schnorr_zkp_correctness<G: MGroup>() -> bool {
    let mut x: <G as Group>::Scalar = <G as Group>::Scalar::random(rand::thread_rng());
    let pow_x = G::g_pow(x);
    ...
    G::Scalar: hacspec_concordium::Serial + hacspec_concordium::Deserial,
{
    ...
    let mut xis: [G::Scalar; n] = [G::Scalar::ZERO; n];
    let mut rp_zkp_randoms: [G::Scalar; n] = [G::Scalar::ZERO; n];
    let mut cvp_zkp_random_ws1: [G::Scalar; n] = [G::Scalar::ZERO; n];
    let mut cvp_zkp_random_rs1: [G::Scalar; n] = [G::Scalar::ZERO; n];
    let mut cvp_zkp_random_ds1: [G::Scalar; n] = [G::Scalar::ZERO; n];

    let mut cvp_zkp_random_ws2: [G::Scalar; n] = [G::Scalar::ZERO; n];
    let mut cvp_zkp_random_rs2: [G::Scalar; n] = [G::Scalar::ZERO; n];
    let mut cvp_zkp_random_ds2: [G::Scalar; n] = [G::Scalar::ZERO; n];
